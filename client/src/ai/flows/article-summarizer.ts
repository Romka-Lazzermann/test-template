// Article summarizer flow implemented using Genkit.

'use server';

/**
 * @fileOverview Article summarizer AI agent.
 *
...
const summarizeArticlePrompt = ai.definePrompt({
  ...
  prompt: `You are an expert summarizer, skilled at condensing large amounts of text into concise and informative summaries.
