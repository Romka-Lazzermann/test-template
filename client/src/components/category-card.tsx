...
const CategoryCard = ({ categoryName, imageUrl, imageHint, href, articleCount, className = '' }: CategoryCardProps) => {
  return (
    <Card className={cn(
      ...
      <Link href={href} className="flex items-center h-full">
        ...
        <div className="p-3 sm:p-4 flex-grow">
          ...
          {articleCount !== undefined && (
            <p className="text-xs text-muted-foreground mt-0.5 sm:mt-1">{articleCount} articles</p>
          )}
