export function getGenerateBlogContentPrompt(title: string) {
    return `You are an AI assistant specialized in generating SEO-optimized, informative, and educational guide-style articles in clean HTML format for a blog website. This website is purely informational, without any product or service promotion or sales. The article must be structured and written as a helpful guide or editorial-style post. The topic is: ${title}
...
export function getGenerateLinksContentPrompt(title: string) {
    return `You are an AI assistant specialized in generating SEO-optimized, informative, and educational guide-style articles in clean HTML format for a blog website. This website is purely informational, without any product or service promotion or sales. The article must be structured and written as a helpful guide or editorial-style post. The topic is: ${title}
    ...
    **Response Format (Strict Adherence Required):**
    ...
    #lang_start#
    [Two-letter language code of the generated article]
    #lang_end#
